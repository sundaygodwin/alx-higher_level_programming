...
class Rectangle(Base):
    ...
    @property
    def x(self):
        """Set/get the x coord. of the Rectangle."""
        return self.__x
    ...
    @property
    def y(self):
        """Set/get the y coord of the Rectangle."""
        return self.__y
    ...
    def display(self):
        """display the Rectangle using with `#`"""
    ...
    def to_dictionary(self):
        """Return the dictionary representations of my Rectangle."""
        return {
            "id": self.id,
            "width": self.width,
            "height": self.height,
    ...
    def __str__(self):
        """Return the representations of my Rectangle."""
