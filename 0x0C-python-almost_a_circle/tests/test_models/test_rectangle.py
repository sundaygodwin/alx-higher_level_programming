...
"""Initialize unit tests for models/rectangle.py.
...
class TestRectangle_instantiation(unittest.TestCase):
    """Unit tests to test instantiation of the Rectangle class."""
...
class TestRectangle_width(unittest.TestCase):
    """Unit tests to test initialization of Rectangle width attribute."""
...
class TestRectangle_height(unittest.TestCase):
    """Unit tests to test initialization of Rectangle height attribute."""
...
class TestRectangle_x(unittest.TestCase):
    """Unit tests to test initialization of Rectangle x attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """Unit tests to test initialization of Rectangle y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unit tests to test Rectangle order of attribute initialization."""

    def test_width_before_height(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
[O            Rectangle("invalid width", "invalid height")
...
class TestRectangle_area(unittest.TestCase):
    """Unit tests to test the area method of the Rectangle class."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unit tests to test __str__ and display methods of Rectangle class."""
...
class TestRectangle_update_args(unittest.TestCase):
    """Unit tests to test update args method of the Rectangle class."""
    ...
    def test_update_args_x_before_y(self):
        r = Rectangle(10, 10, 10, 10, 10)
[I        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            r.update(89, 1, 2, "invalid", "invalid")


class TestRectangle_update_kwargs(unittest.TestCase):
    """Unit tests to test update kwargs method of the Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Unit tests to test to_dictionary method of the Rectangle class."""
