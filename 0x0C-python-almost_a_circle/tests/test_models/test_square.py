...
"""Initialize unit test for models/square.py.
...
class TestSquare_size(unittest.TestCase):
    """Unit test for test size initialization of the Square class."""
...
class TestSquare_y(unittest.TestCase):
    """Unit test to test initialization of Square y attribute."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unit tests to test order of Square attribute initialization."""
...
class TestSquare_area(unittest.TestCase):
    """Unit test to test the area method of the Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unit test to test update kwargs method of Square class."""
